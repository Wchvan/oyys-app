<template>
  <view class="container">
    ...
    <view v-if="selectValue === '套餐' && setList.length" class="top">
      <view class="second item">
        <text class="iconfont second-icon">&#xe872;</text>
        <view class="text"
          >{{ setList[1].name }} <br />
          {{ setList[1].supplierName }}</view
        >
      </view>
      ...
      <view class="third item">
        ...
        <view class="text"
          >{{ setList[2].name }} <br />
          {{ setList[2].supplierName }}</view
        >
      </view>
    </view>
    <view v-if="selectValue === '套餐' && setList.length" class="main">
      <view
        v-for="(item, index) in setList.slice(2)"
        :key="index"
        class="bank-item"
      >
    ...
    <view v-if="selectValue !== '套餐' && supplierList.length" class="top">
      <view class="second item">
        <text class="iconfont second-icon">&#xe872;</text>
    ...
    <view v-if="selectValue !== '套餐' && supplierList.length" class="main">
      <view
        v-for="(item, index) in supplierList.slice(2)"
        :key="item.id"
        class="bank-item"
      >
        <text>{{ index + 3 }}. &ensp;</text>
