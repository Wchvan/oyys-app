  ...
  <view class="container">
    ...
    <view class="top">
      <view class="second item">
        ...
        <view v-if="value === '套餐'" class="text">XX套餐<br />XX供应商</view>
        <view v-else class="text">XX供应商</view>
      </view>
    ...
    <view class="main">
      <view v-for="item in 7" :key="item" class="bank-item">
        <text>{{ item + 3 }}. &ensp;</text>
        <text>{{ value === '套餐' ? 'XX套餐 - XX供应商' : 'XX供应商' }}</text>
      </view>
    </view>
  </view>
</template>
